...
class Responsable implements UserInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\UserType", inversedBy="responsables")
     */
    private $type;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Commentaires", mappedBy="authorClient")
     */
    ...
    public function addCommentaire(Commentaires $commentaire): self
    {
        if (!$this->commentaires->contains($commentaire)) {
            ...
            $commentaire->setAuthorClient($this);
        }
    ...
    public function removeCommentaire(Commentaires $commentaire): self
    {
        if ($this->commentaires->contains($commentaire)) {
            ...
            // set the owning side to null (unless already changed)
            if ($commentaire->getAuthorClient() === $this) {
                $commentaire->setAuthorClient(null);
            }
        }
